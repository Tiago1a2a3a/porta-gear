"""Operações do relé conectado ao GPIO52 do Luckfox."""
...
class ReleLuckfox:
    """Controla o relé ativo em nível baixo usando o sysfs do Linux."""
    ...
    def configurar(self) -> None:
        """Exporta o GPIO e deixa o relé desligado em estado seguro."""
    ...
    def abrir_porta(self) -> None:
        """Executa os pulsos LOW/HIGH configurados para abrir a porta."""
    ...
    def _escrever(self, nivel: int) -> None:
        ...
        try:
            ...
            raise ErroRele(
                f"Não foi possível escrever no GPIO{self.numero_gpio}: {erro}"
            ) from erro
